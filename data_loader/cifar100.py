...
def get_cifar100(root, cfg_trainer, train=True,
                ...
                download=False, noise_file = None, validation_split=0):
...
def cifar100n(root, key, download = False):
...
# uniform split
def train_val_split(base_dataset: torchvision.datasets.CIFAR100, validation_split=0):
    num_classes = 100
...
class CIFAR100_val(torchvision.datasets.CIFAR100):
    ...
    def __init__(self, root, cfg_trainer, indexs, train=False,
